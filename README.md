...
| `showSchedule`        | `true`                | _Optional_ - Whether the show the upcoming Race Schedule and track layout.                                                                                              | `true` or `false`.                                                                                                           |
...
| `grayscale`       | `true`                 | _Optional_ - Whether to show the flags, constructor icon and circuit layout in grayscale (`true`) or colour (`false`). In colour the circuit layout show the sectors also.                                                                                               | `true` or `false`                                                                                                            |
